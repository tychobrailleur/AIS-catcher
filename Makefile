...
OBJ = Config.o DeviceManager.o Main.o MapTiles.o Prometheus.o Receiver.o WebDB.o WebViewer.o PostgreSQL.o AIRSPY.o AIRSPYHF.o FileRAW.o FileWAV.o HACKRF.o HYDRASDR.o N2KsktCAN.o RTLSDR.o RTLTCP.o SDRPLAY.o Serial.o SoapySDR.o SpyServer.o UDP.o ZMQ.o Demod.o DSP.o Model.o HTTPClient.o HTTPServer.o MsgOut.o Screen.o N2KInterface.o N2KStream.o Network.o Protocol.o JSON.o JSONAIS.o Keys.o Parser.o StringBuilder.o ADSB.o Basestation.o Beast.o AIS.o Message.o N2K.o NMEA.o Logger.o TCPServer.o DB.o Ships.o Parse.o Convert.o Helper.o TemplateString.o StreamHelpers.o
